$PBExportHeader$nvo_derivedabclass.sru
forward
global type nvo_derivedabclass from dotnetobject
end type
end forward
...
global nvo_derivedabclass nvo_derivedabclass

type variables

PUBLIC:
String is_assemblypath = "DemoAPI.dll"
String is_classname = "DemoAPI.AbstractTest1+DerivedAbClass"
...
public function string of_abclasstest()
public function long of_getarea()
public function long of_getcost()
public function string of_printabclass()
end prototypes
...
on nvo_derivedabclass.create
call super::create
TriggerEvent( this, "constructor" )
end on

on nvo_derivedabclass.destroy
