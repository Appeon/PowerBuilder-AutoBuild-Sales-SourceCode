$PBExportHeader$nvo_taskbarutil.sru
forward
global type nvo_taskbarutil from dotnetobject
end type
end forward
...
global nvo_taskbarutil nvo_taskbarutil

type variables

PUBLIC:
String is_assemblypath = "DemoAPI.dll"
String is_classname = "DemoAPI.TaskBarUtil"
...
public subroutine  of_refreshnotificationarea()
end prototypes
...
public subroutine  of_refreshnotificationarea();
//*-----------------------------------------------------------------*/
//*  .NET function : RefreshNotificationArea
//*   Return : (None)
//*-----------------------------------------------------------------*/
/* .NET  function name */
String ls_function
...
ls_function = "RefreshNotificationArea"
...
on nvo_taskbarutil.create
call super::create
TriggerEvent( this, "constructor" )
end on

on nvo_taskbarutil.destroy
