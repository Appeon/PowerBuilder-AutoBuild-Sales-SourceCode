...
Try
	...
	lbln_result = This.blockinput(abln_fblocklt)
	Return lbln_result
...
Try
	...
	/* Trigger the dotnet function */
	lbln_result = This.lockworkstation()
	Return lbln_result
Catch(runtimeerror re_error)
